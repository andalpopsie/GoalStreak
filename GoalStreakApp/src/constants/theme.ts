...
export const getCategoryBackgroundColor = (category: string): string => {
  ...
  switch (color) {
    case Colors.fitnessOrange:
      return '#F5F0FD'; // Very light purple (#B771E5)
    case Colors.wellnessTeal:
      return '#E8F5F4'; // Very light teal (#48B3AF)
    case Colors.nutritionGreen:
      return '#F0FBE8'; // Very light green (#A7E399)
    case Colors.socialPurple:
      return '#F5F5F4'; // Very light gray (#3C3D37)
    case Colors.productivityNavy:
      return '#E8EBF0'; // Very light navy (#003161)
    case Colors.otherPink:
      return '#FFF4E8'; // Very light orange (#FF9013)
    default:
